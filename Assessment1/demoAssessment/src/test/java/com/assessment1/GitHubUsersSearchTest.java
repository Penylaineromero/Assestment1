...
public class GitHubUsersSearchTest {
    ...
    @Test(description = "This test validates the url")
    ...
    public void Non_ExistingUser(){
        ...
        inv_user.sendKeys("Invalid User" + Keys.ENTER);
    ...
    public void UserDetailsPage_HomePage(WebElement userDetails){
        ...
        varObj.typeOnSearchBar("mahmudalhakim" + Keys.ENTER);
        varObj.pause(3000);
    ...
    public void UserDetailsPage_Github(){
        ...
        Assert.assertEquals(driver.getTitle(), "mahmudalhakim (Mahmud Al Hakim) · GitHub");
    ...
    public void UserRepositoriesPage(){
        ...
        Assert.assertEquals(driver.getTitle(), "mahmudalhakim (mahmudalhakim) / Repositories · GitHub");
